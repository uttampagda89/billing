...
def AddNewWindow():
    ...
    # ===================LABELS==============================
    lbl_title = Label(FormTitle, text="Add Item", font=('arial', 16), bg="gray", width=300)
...
# ============================FRAMES======================================
Top = Frame(root, width=500, bd=1,bg="grey" ,relief=SOLID)
Top.pack(side=TOP)
Mid = Frame(root, width=500, bg="grey")
Mid.pack(side=TOP)
MidLeft = Frame(Mid, width=100,bg="grey")
MidLeft.pack(side=LEFT, pady=10)
MidLeftPadding = Frame(Mid, width=370, bg="grey")
MidLeftPadding.pack(side=LEFT)
MidRight = Frame(Mid, width=100,bg="grey")
MidRight.pack(side=RIGHT, pady=10,)
TableMargin = Frame(root, width=500)
TableMargin.pack(side=TOP)
# ============================LABELS======================================
lbl_title = Label(Top, text="Shree Raj Marble",fg="black", bg="purple",font=('arial', 16), width=500)
lbl_title.pack(fill=X)
